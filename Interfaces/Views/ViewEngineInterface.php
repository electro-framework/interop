...
interface ViewEngineInterface
{
   ...
   *
   * @param mixed              $template The compiled template,or the original source code if the engine does not
   *                                     support template compilation. When called from a View, this is guaranteed to
   *                                     be non-null.
   * @param ViewModelInterface $data     The view model; optional data for use by data binding expressions on the
   *                                     template.
   * @return string The generated output (ex: HTML).
   */
  function render ($template, ViewModelInterface $data = null);

...
interface RedirectionInterface
{
   ...
   *
   * <p>If the URL begins with /, the redirection URL path will be set to that value exactly.
   * <p>If the URL is relative, the redirection URL path will be set to the application's root path plus that URL.
   * <p>If the URL is empty, the redirection will be performed to the application's root path.
   * <p>If the URL is absolute, it will be used as is.
   *
